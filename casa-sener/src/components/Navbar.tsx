...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm border-b border-white/10" style={{background: 'linear-gradient(to bottom, rgba(42,42,42,0.97), rgba(22,22,22,0.97))'}}>
      <nav
