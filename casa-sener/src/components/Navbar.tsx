...
const linkClass =
  "hidden lg:block text-sm font-medium text-[var(--color-brand-dark)] hover:text-[var(--color-brand-red)] px-3 py-2 rounded-lg transition-colors duration-200";
