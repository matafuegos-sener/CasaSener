...
**Falta un paso manual tuyo, un solo pegado para las dos migraciones nuevas de hoy** (`0008_estado_crm.sql` y `0009_fecha_categoria.sql`) en el SQL Editor de Supabase, mismo lugar de siempre. Sin esto, cargar una cotización/pedido/problema o registrar cualquier interacción sigue funcionando, pero el estado y la fecha nuevos no se guardan hasta que existan las columnas.
